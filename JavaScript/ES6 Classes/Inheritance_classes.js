...
// Inheritance in ES6 classes is achieved using the 'extends' keyword. The 'super' keyword is used to call the constructor of the parent class (Vehicle) from the child class (Car). This allows the Car class to inherit properties and methods from the Vehicle class.
